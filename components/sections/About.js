    ...
    <div className="p-8 pt-4 md:pt-10 md:px-16 flex flex-col lg:flex-row lg:items-center">
        <div className="lg:w-3/5">
            <Fade duration={200} distance="30px" bottom>
                ...
                <p className="text-gray-600 mt-8 lg:text-justify tracking-wide">
            ...
            <ul className="mt-3 ml-4 text-gray-600 tracking-wide">
                ...
                <Fade duration={200} delay={200} distance="30px" bottom>
